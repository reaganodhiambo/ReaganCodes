...
const About = () => {
  return (
    <main className="bg-dark-background min-h-screen py-16 px-4">
      <PageTitle title="About Me" description="The human behind the code - Reagan Odhiambo's story, skills, and personality" />
      ...
      <div className="container mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
          <div className="order-2 md:order-1">
            <h2 className="text-3xl font-bold mb-6">Reagan <span className="text-accent-purple">Odhiambo</span></h2>
        ...
        <div className="mb-16">
          <h2 className="text-3xl font-bold mb-8 text-accent-purple">tech<span className="text-white">/</span>stack</h2>
        ...
        {/* Fun Facts Section */}
        <div className="mb-16">
          <h2 className="text-3xl font-bold mb-8 text-accent-purple">fun<span className="text-white">/</span>facts</h2>
            ...
            {[
              {
                ...
                icon: <FaCode className="text-accent-purple text-4xl" />
              },
              {
                ...
                icon: <FaCoffee className="text-accent-purple text-4xl" />
              },
              {
                title: "Rollball MVP",
                ...
                icon: <FaSkating className="text-accent-purple text-4xl" />
              }
            ].map((item, index) => (
              <div
                key={index}
        ...
        <div className="bg-card rounded-lg p-8 border border-gray-700 mb-16 text-center">
          <FaRegLightbulb className="text-accent-purple text-4xl mx-auto mb-4" />
          <blockquote className="text-2xl italic mb-4">
            "I don't always test my code, but when I do, I do it in production."
          </blockquote>
          <p className="text-accent-purple">— Me, just kidding (maybe)</p>
        </div>

        {/* Skills Summary */}
        <div className="bg-card rounded-lg p-8 border border-gray-700 mb-16">
          <div className="flex items-center gap-4 mb-6">
            <FaLaptopCode className="text-accent-purple text-4xl" />
            <h2 className="text-3xl font-bold">Skills<span className="text-accent-purple">/</span>Summary</h2>
          </div>
